...
const stroke = (size: number, sw = 1.8) => ({
  width: size,
  height: size,
  viewBox: "0 0 24 24",
  fill: "none",
...
export const GithubIcon = ({ size = 13 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
    <path d="M12 .5C5.65.5.5 5.65.5 12c0 5.08 3.29 9.39 7.86 10.91.58.1.79-.25.79-.56v-2.17c-3.2.7-3.87-1.36-3.87-1.36-.52-1.33-1.28-1.68-1.28-1.68-1.04-.71.08-.7.08-.7 1.15.08 1.76 1.18 1.76 1.18 1.03 1.76 2.7 1.25 3.35.96.1-.75.4-1.25.73-1.54-2.55-.29-5.24-1.28-5.24-5.68 0-1.26.45-2.28 1.18-3.09-.12-.29-.51-1.46.11-3.04 0 0 .97-.31 3.17 1.18a11 11 0 0 1 5.78 0c2.2-1.49 3.16-1.18 3.16-1.18.63 1.58.24 2.75.12 3.04.74.81 1.18 1.83 1.18 3.09 0 4.41-2.69 5.38-5.26 5.67.41.36.78 1.06.78 2.13v3.16c0 .31.21.67.8.56A11.5 11.5 0 0 0 23.5 12C23.5 5.65 18.35.5 12 .5z" />
  </svg>
);

export const LinkedinIcon = ({ size = 12 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
export const MailIcon = ({ size = 13 }: IconProps) => (
  <svg {...stroke(size)}>
...
export const DownloadIcon = ({ size = 13 }: IconProps) => (
  <svg {...stroke(size, 2)}>
    <path d="M12 3v12" />
...
export const ShareIcon = ({ size = 14 }: IconProps) => (
  <svg {...stroke(size, 2)}>
...
export const ChevronIcon = ({ size = 18, style }: IconProps) => (
  <svg {...stroke(size, 2.2)} style={style}>
    <path d="m9 6 6 6-6 6" />
  </svg>
);
...
export const MicOffIcon = ({ size = 16 }: IconProps) => (
  <svg {...stroke(size, 2)}>
    <path d="m2 2 20 20" />
    <path d="M18.9 13.1A7 7 0 0 1 5 12v-2" />
...
export const HangUpIcon = ({ size = 16 }: IconProps) => (
  <svg {...stroke(size, 2)}>
